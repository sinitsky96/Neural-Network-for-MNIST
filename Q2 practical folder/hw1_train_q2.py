...
def Q2():
    ...
    #take first 128 samples of train_dataset
    train_dataset.data = train_dataset.data[:128]
    #apply labels 0 and 1 to train_dataset randomly from a bernoulli distribution with p=0.5
    train_dataset.targets = torch.bernoulli(torch.ones(128) * 0.5)
    #take first 128 samples of test_dataset
    ...
    for epoch in range(num_epochs):
        loss = model.train(train_loader, epoch, num_epochs, learning_rate)
